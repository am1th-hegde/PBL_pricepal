...
search_box = driver.find_element(By.CSS_SELECTOR,'.Pke_EE')
...
try:
    first_result = driver.find_element(By.CSS_SELECTOR,'div._1AtVbE:nth-child(4) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > a:nth-child(1)')
    product_url = first_result.get_attribute("href")
except Exception as e:
    try:
        first_result = driver.find_element(By.CSS_SELECTOR,'div._1YokD2:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(3) > div:nth-child(1) > a:nth-child(2)')
        product_url = first_result.get_attribute("href")
    except:
        first_result = driver.find_element(By.CSS_SELECTOR,'div._1YokD2:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(3) > div:nth-child(1) > a:nth-child(2)')
        product_url = first_result.get_attribute("href")
